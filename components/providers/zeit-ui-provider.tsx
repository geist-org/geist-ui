...
import { ZEITUIContent, ZeitUiContextParams, UpdateToastsFunction } from '../utils/use-zeit-ui-context'
...
const ZEITUIProvider: React.FC<PropsWithChildren<Props>> = ({
  theme, children,
}) => {
  ...
  const updateToasts: UpdateToastsFunction<ToastWithID> = (fn: (toasts: ToastWithID[]) => ToastWithID[]) => {
