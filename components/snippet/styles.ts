...
export const getStyles = (type: SnippetColors, palette: ZeitUIThemesPalette, fill?: boolean) => {
  const styles: { [key in SnippetColors]: SnippetStyles } = {
    default: {
  ...
  const filledTypes: Array<SnippetColors> = ['success', 'warning', 'error', 'secondary']
