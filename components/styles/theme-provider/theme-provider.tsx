...
type PartialTheme = DeepPartial<CfxUIThemes>
...
const mergeTheme = (current: CfxUIThemes, custom: ThemeParam): CfxUIThemes => {
  ...
  if (typeof custom === 'function') {
    ...
    return merged as CfxUIThemes
  }
  return deepMergeObject<CfxUIThemes>(current, custom as CfxUIThemes)
}

const switchTheme = (mergedTheme: CfxUIThemes): CfxUIThemes => {
  const themes: { [key in CfxUIThemes['type']]: CfxUIThemes } = {
    light: lightTheme,
    dark: darkTheme,
  }
