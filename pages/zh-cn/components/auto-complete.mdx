...
() => {
  ...
  return (
    <div style={{display: 'flex'}}>
      <AutoComplete options={options} placeholder="在这里输入" onSearch={searchHandler} />
      <Spacer inline />
      <AutoComplete variant="solid" options={options} placeholder="在这里输入" onSearch={searchHandler} />
    </div>
  )}
`}
/>
...
() => {
  ...
  return (
  <div  style={{display: 'flex'}}>
  <AutoComplete placeholder="在这里输入" clearable options={options} />
  <Spacer inline />
