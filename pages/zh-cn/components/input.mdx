...
<Playground
  ...
  code={`
<>
  <Input size="mini" icon={<GitIcon />} placeholder="输入 Git 地址" />
  <Spacer y={.5} />
  <Input size="small" icon={<GitIcon />} placeholder="输入 Git 地址" />
  <Spacer y={.5} />
  <Input size="medium" icon={<GitIcon />} placeholder="输入 Git 地址" />
  <Spacer y={.5} />
  <Input size="large" icon={<GitIcon />} placeholder="输入 Git 地址" />
  <Spacer y={.5} />
  <Input size="mini" iconRight={<GitIcon />} placeholder="输入 Git 地址" />
  <Spacer y={.5} />
  <Input size="small" iconRight={<GitIcon />} placeholder="输入 Git 地址" />
  <Spacer y={.5} />
  <Input size="medium" iconRight={<GitIcon />} placeholder="输入 Git 地址" />
  <Spacer y={.5} />
  <Input size="large" iconRight={<GitIcon />} placeholder="输入 Git 地址" />
</>
`}
/>
