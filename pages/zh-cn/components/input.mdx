...
<>
  ...
  <Spacer inline />
  <Input solid size="mini" placeholder="mini" />
  <Spacer y={.5} />
  <Input size="small" placeholder="small" />
  <Spacer inline />
  <Input solid size="small" placeholder="small" />
  <Spacer y={.5} />
  <Input size="medium" placeholder="medium" />
  <Spacer inline />
  <Input solid size="medium" placeholder="medium" />
  <Spacer y={.5} />
  <Input size="large" placeholder="large" />
  <Spacer inline />
  <Input solid size="large" placeholder="large" />
</>
`}
/>
