...
| **labelPageSizeChangerBefore** | 自定义pageSizeChanger组件之前的文本  | `ReactNode` / `string`    | -                                         | `SHOW`                    |
| **labelPageSizeChangerAfter**  | 自定义pageSizeChanger组件之后的文本  | `ReactNode` / `string`    | -                                         | `RECORDS`                 |
| **labelQuickJumperBefore**     | 自定义quickJumper组件之前的文本      | `ReactNode` / `string`    | -                                         | `GO TO`                   |
| **labelQuickJumperAfter**      | 自定义quickJumper组件之后的文本      | `ReactNode` / `string`    | -                                         | `PAGE`                    |
