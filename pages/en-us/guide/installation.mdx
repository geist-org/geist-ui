...
<Tabs initialValue="yarn" hideDivider>
  <Tabs.Item label="Yarn" value="yarn">
    <Snippet width="400px">yarn add @geist-ui/core</Snippet>
  </Tabs.Item>
  <Tabs.Item label="Npm" value="npm">
    <Snippet width="400px">npm i @geist-ui/core</Snippet>
  </Tabs.Item>
</Tabs>
<Spacer h={1.5} />
...
Some fonts in Web applications do not render best on the _Windows_ platform, or you may think font rendering is not good enough for some character sets (like Chinese rendering). In this case, you can introduce additional font packages to optimize the rendering:
