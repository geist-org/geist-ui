...
<Note>
  Before using any Components, you must add <Code>ZeitProvider</Code> to the root node.
</Note>
<Spacer y={0.5} />
<Note type="success">
...
Here is <Link target="_blank" href="https://github.com/zeit-ui/react/tree/master/examples/custom-themes">a complete sample project</Link> for reference.
...
If you don't use TypeScript, to learn more about preset types, see <Link target="_blank" href="https://github.com/zeit-ui/react/blob/master/components/styles/themes/index.ts">here</Link>.
