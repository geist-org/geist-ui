...
<Playground
  ...
  scope={{ Tooltip }}
  code={`
<Tooltip text={'Push to Git and your website is live.'} trigger="click" color="dark">
  <span>Click me</span>
</Tooltip>
`}
/>
...
<Playground
  ...
  code={`
<Row align="middle">
  <Tooltip text={'Push to Git and your website is live.'} color="dark">
...
<Playground
  ...
  code={`
<Row align="middle">
  <Tooltip text="Perfect for working with a CMS." color="dark">
    <span>Dark</span>
  </Tooltip>
  <Spacer inline x={1.5} />
...
<Playground
  ...
  code={`
<Row align="middle">
  <Tooltip text="Push to Git and your website is live." color="lite">
    <span>Lite</span>
  </Tooltip>
  <Spacer inline x={2.5} />
...
() => {
  ...
  return (
    <div style={{ width: '80%', margin: '0 auto' }}>
      <Row justify="center">
        <Center span={5}>
          <Tooltip text={text} placement="topStart" color="dark">topStart</Tooltip>
        </Center>
        <Center span={5}>
          <Tooltip text={text} placement="top" color="dark">top</Tooltip>
        </Center>
        <Center span={5}>
          <Tooltip text={text} placement="topEnd" color="dark">topEnd</Tooltip>
        </Center>
      </Row>
      <Row justify="space-between">
        <Center span={5}>
          <Tooltip text={text} placement="leftStart" color="dark">leftStart</Tooltip>
        </Center>
        <Center span={5}>
          <Tooltip text={text} placement="rightStart" color="dark">rightStart</Tooltip>
        </Center>
      </Row>
      <Spacer y={.5} />
      <Row justify="space-between">
        <Center span={5}>
          <Tooltip text={text} placement="left" color="dark">left</Tooltip>
        </Center>
        <Center span={5}>
          <Tooltip text={text} placement="right" color="dark">right</Tooltip>
        </Center>
      </Row>
      <Spacer y={.5} />
      <Row justify="space-between">
        <Center span={5}>
          <Tooltip text={text} placement="leftEnd" color="dark">leftEnd</Tooltip>
        </Center>
        <Center span={5}>
          <Tooltip text={text} placement="rightEnd" color="dark">rightEnd</Tooltip>
        </Center>
      </Row>
      <Row justify="center">
        <Center span={5}>
          <Tooltip text={text} placement="bottomStart" color="dark">bottomStart</Tooltip>
        </Center>
        <Center span={5}>
          <Tooltip text={text} placement="bottom" color="dark">bottom</Tooltip>
        </Center>
        <Center span={5}>
          <Tooltip text={text} placement="bottomEnd" color="dark">bottomEnd</Tooltip>
        </Center>
      </Row>
    </div>
  )
