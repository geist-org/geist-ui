...
<Playground
  ...
  width="750px"
  code={`
      <Pagination total={50}  initialPage={3} />
`}
/>
...
<>
  ...
  <Spacer y={.5} />
  <Pagination total={100} initialPage={6} limit={5} />
  <Spacer y={.5} />
  <Pagination total={100} initialPage={6} />
  <Spacer y={.5} />
  <Pagination total={240} initialPage={6} limit={10} />
</>
`}
/>
...
| **initialPage**         | Default initial page number                                                                               | `number`                                 | -                                         | 1                         |
