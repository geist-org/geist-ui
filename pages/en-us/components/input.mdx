...
<Playground
  ...
  code={`
<>
  <Input size="mini" icon={<GitIcon />} placeholder="GitHub" />
  <Spacer y={.5} />
  <Input size="small" icon={<GitIcon />} placeholder="GitHub" />
  <Spacer y={.5} />
  <Input size="medium" icon={<GitIcon />} placeholder="GitHub" />
  <Spacer y={.5} />
  <Input size="large" icon={<GitIcon />} placeholder="GitHub" />
  <Spacer y={.5} />
  <Input size="mini" iconRight={<GitIcon />} placeholder="GitHub" />
  <Spacer y={.5} />
  <Input size="small" iconRight={<GitIcon />} placeholder="GitHub" />
  <Spacer y={.5} />
  <Input size="medium" iconRight={<GitIcon />} placeholder="GitHub" />
  <Spacer y={.5} />
  <Input size="large" iconRight={<GitIcon />} placeholder="GitHub" />
  <Spacer y={.5} />
</>
`}
/>
