...
import { InfoIcon } from './test-icons.tsx'
...
<Playground
  ...
  scope={{ Input, InfoIcon, Spacer }}
  code={`
<>
  <Input size="mini" icon={<InfoIcon />} placeholder="GitHub" />
  <Spacer y={.5} />
  <Input size="small" icon={<InfoIcon />} placeholder="GitHub" />
  <Spacer y={.5} />
  <Input size="medium" icon={<InfoIcon />} placeholder="GitHub" />
  <Spacer y={.5} />
  <Input size="large" icon={<InfoIcon />} placeholder="GitHub" />
  <Spacer y={.5} />
  <Input size="mini" iconRight={<InfoIcon />} placeholder="GitHub" />
  <Spacer y={.5} />
  <Input size="small" iconRight={<InfoIcon />} placeholder="GitHub" />
  <Spacer y={.5} />
  <Input size="medium" iconRight={<InfoIcon />} placeholder="GitHub" />
  <Spacer y={.5} />
  <Input size="large" iconRight={<InfoIcon />} placeholder="GitHub" />
  <Spacer y={.5} />
</>
`}
/>
