...
<>
  ...
  <Spacer inline />
  <Input variant="solid" placeholder="The Evil Rabbit" />
</>
`}
/>
...
<>
  ...
  <Spacer inline />
  <Input variant="solid" size="mini" placeholder="Mini Input" />
  <Spacer y={.5} />
  <Input size="small" placeholder="Small Input" />
  <Spacer inline />
  <Input variant="solid" size="small" placeholder="Small Input" />
  <Spacer y={.5} />
  <Input size="medium" placeholder="Medium Input" />
  <Spacer inline />
  <Input variant="solid" size="medium" placeholder="Medium Input" />
  <Spacer y={.5} />
  <Input size="large" placeholder="Large Input" />
  <Spacer inline />
  <Input variant="solid" size="large" placeholder="Large Input" />
</>
`}
/>
...
<>
  ...
  <Input variant="solid" placeholder="The Evil Rabbit" width="100%" />
</>
`}
/>
...
<>
  ...
  <Spacer inline />
  <Input variant="solid" readOnly initialValue="readOnly" />
</>
`}
/>
...
<>
  ...
  <Spacer y={.5} />
  <Input label="username" variant="solid" placeholder="The Evil Rabbit" />
  <Spacer inline />
...
<>
  ...
  <Spacer />
  <Input variant="solid" placeholder="Evil Rabbit">
    Username
  </Input>
  <Spacer />
...
<Playground
  ...
  code={`
<>
  <Input color="primary" initialValue="The Evil Rabbit" />
  <Spacer inline />
  <Input variant="solid" color="primary" initialValue="The Evil Rabbit" />
  <Spacer y={.5} />
  <Input color="error" initialValue="The Evil Rabbit" />
  <Spacer inline />
  <Input variant="solid" color="error" initialValue="The Evil Rabbit" />
</>
`}
/>
...
<>
  ...
  <Spacer inline />
  <Input.Password variant="solid" initialValue="123456abc" />
</>
`}
/>
...
<>
  ...
  <Spacer inline />
  <Input variant="solid" clearable initialValue="The Evil Rabbit" placeholder="The Evil Rabbit" />
</>
`}
/>
