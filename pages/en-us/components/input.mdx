...
<Playground
  ...
  code={`
<>
  <Input size="mini" placeholder="Mini Input" /> <Spacer h={.5} />
  <Input size="small" placeholder="Small Input" /> <Spacer h={.5} />
  <Input size="medium" placeholder="Medium Input" /> <Spacer h={.5} />
